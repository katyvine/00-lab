...
function displayPics(){
  ...
  // 'let' does not create a global variable if it has not yet been defined in the code block. 'rando' calls the 'makeRandom' function which is outside the 'displayPics' function where 'rando' is defined.
  console.log(viewed);
